...
class Search(forms.Form):
    item = forms.CharField(widget=forms.TextInput(attrs={'class' : 'myfieldclass', 'placeholder': '  Search', 'style':'border: 2px black solid;border-radius: 20px;width:100%;margin-top:10px;margin-bottom:10px;height:35px;'}))

class Post(forms.Form):
    title = forms.CharField(label= "Title")
    textarea = forms.CharField(widget=forms.Textarea(attrs={'style':'height:400px;length:300px;'}), label='')
